...
export const GlamourPage1Template = ({ title, content, contentComponent, img, author }) => {
...
GlamourPage1Template.propTypes = {
...
GlamourPage1.propTypes = {
  data: PropTypes.object.isRequired,
}

export default GlamourPage1

export const glamourPage1Query = graphql`
  query GlamourPage1($id: String!) {
