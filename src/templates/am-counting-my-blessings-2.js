...
export const AmCountingMyBlessings2PageTemplate =
...
AmCountingMyBlessings2PageTemplate.propTypes = {
...
AmCountingMyBlessings2Page.propTypes = {
  data: PropTypes.object.isRequired,
}

export default AmCountingMyBlessings2Page

export const amCountingMyBlessings2PageQuery = graphql`
  query AmCountingMyBlessings2Page($id: String!) {
