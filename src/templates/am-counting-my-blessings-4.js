...
export const AmCountingMyBlessings4PageTemplate =
...
AmCountingMyBlessings4PageTemplate.propTypes = {
...
AmCountingMyBlessings4Page.propTypes = {
  data: PropTypes.object.isRequired,
}

export default AmCountingMyBlessings4Page

export const amCountingMyBlessings4PageQuery = graphql`
  query AmCountingMyBlessings4Page($id: String!) {
