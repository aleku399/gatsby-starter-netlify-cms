...
export const GlamourPage2Template = ({ title, content, contentComponent, img, author }) => {
...
GlamourPage2Template.propTypes = {
...
GlamourPage2.propTypes = {
  data: PropTypes.object.isRequired,
}

export default GlamourPage2

export const glamourPage2Query = graphql`
  query GlamourPage2($id: String!) {
