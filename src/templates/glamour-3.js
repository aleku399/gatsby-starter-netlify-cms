...
export const GlamourPage3Template = ({ title, content, contentComponent, img, author }) => {
...
GlamourPage3Template.propTypes = {
...
GlamourPage3.propTypes = {
  data: PropTypes.object.isRequired,
}

export default GlamourPage3

export const glamourPage3Query = graphql`
  query GlamourPage3($id: String!) {
